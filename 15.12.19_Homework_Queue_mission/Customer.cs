...
namespace _15._12._19_Homework_Queue_mission
{
    class Customer : PictureBox
    {
        ...
        public override string ToString()
        {
            ...
            var childTypes = this.GetType().GetProperties().Where(x => x.DeclaringType == typeof(Customer) && !x.GetValue(this).GetType().Name.Equals("Boolean") && !x.GetValue(this).GetType().Name.Equals("Guid")).ToArray();
